...
| # | 问题 | 优先级 | 状态 | 说明 |
|---|------|--------|------|------|
| 1 | 🔴 转录重复文本 | P0 | 🚧 进行中 | "去皮皮皮"、"这这这这这" 等重复 → [[DEDUP_ANALYSIS\|分析文档]] [[TASKS_2026-05-24\|今日任务]] |
| 2 | 多音频源支持 | P1 | 代码已添加，待测试 | 同时监听麦克风+声卡 |
| 3 | VAD Errno 22 错误 | P1 | 已加类型转换，待验证 | 偶发，可能内存/缓冲问题 |
| 4 | 数字识别优化 | P2 | 待优化 | 如"6.3""7.2"被识别为中文，需保留阿拉伯数字 |
| 5 | 内存占用优化 | P1 | 待分析 | 服务占用2G+内存，分析优化空间 |
| 6 | 英文缩写多余空格 | P2 | 待优化 | 识别"ppt""pdf""gpt"时字母间有空格，需去除 |
| 7 | Paraformer 替代测试 | P1 | 待测试 | Paraformer内置标点，可能替代SenseVoice+PUNC |
